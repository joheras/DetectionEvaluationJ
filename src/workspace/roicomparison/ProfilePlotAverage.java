...
public class ProfilePlotAverage {
	...
	public ProfilePlotAverage() {
	}

	public ProfilePlotAverage(ImagePlus imp) {
		this(imp, false);
	}

	public ProfilePlotAverage(ImagePlus imp, boolean averageHorizontally) {
		this.imp = imp;
		Roi roi = imp.getRoi();
		if (roi==null) {
	...
	public static void setMinAndMax(double min, double max) {
		fixedMin = min;
		fixedMax = max;
		IJ.register(ProfilePlotAverage.class);
	}
