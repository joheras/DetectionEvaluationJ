 ...
 * @author joheras
 */
public class RoiCompareSeveralPoints {
    ...
    public RoiCompareSeveralPoints(ArrayList<Roi> truerois, ArrayList<Roi> points,ImagePlus imp) {
        ...
        border.add(0);
        for(Roi r : truerois){
            border.add(r.getBounds().y + r.getBounds().height);
        }
        border.add(imp.getHeight());
